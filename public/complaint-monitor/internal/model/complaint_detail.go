...
type ComplaintDetail struct {
	...
	ComplaintID      uint      `gorm:"column:complaint_id;not null;index:idx_complaint_id" json:"complaint_id"`
	...
	ComplaintNo      string    `gorm:"column:complaint_no;not null;size:64;uniqueIndex:uniq_complaint_order" json:"complaint_no"`
	MerchantOrderNo  string    `gorm:"column:merchant_order_no;not null;size:64;uniqueIndex:uniq_complaint_order;index:idx_merchant_order_no" json:"merchant_order_no"`
